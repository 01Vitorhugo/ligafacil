...
export default function CardGame({ horario, data, endereco, nomeTime, rua, numero, cep }) {
    ...
    return (
        <div className="w-full h-auto flex flex-col items-center justify-center mt-15 ">
            ...
            <div className="bg-cover bg-center w-[90%] h-auto rounded-lg shadow-[1px_1px_5px_rgba(255,255,255,0.5)] relative  overflow-hidden flex flex-col ">
                <div
                ...
                <section className="border-b-1 border-colorPrinOpacity h-auto flex items-center p-3">
